...
% 2017/02/19: I added an input (h) for the handles from the GUI I'm calling
% this function from. I have saved into the handles variable the positions
...
%% Code
function [out1,out2,out3,out4] = myginput(arg1,strpointertype)
out1 = []; out2 = []; out3 = []; y = []; z = [];
